...
class Popouts {
    ...
    static initialize() {
        ...
        this.container = Object.assign(document.createElement("div"), {
            className: "wakh_NITRO_LibraryPopoutsRenderer",
            style: "display: none;"
        });

        this.layerContainer = Object.assign(document.createElement("div"), {
            id: "wakh_NITRO_LibraryPopouts",
    ...
    static dispose() {
        ...
        const container = document.querySelector(".wakh_NITRO_LibraryPopoutsRenderer");
        const layerContainer = document.querySelector("#wakh_NITRO_LibraryPopouts");
...
class PluginLibrary extends _structs_plugin__WEBPACK_IMPORTED_MODULE_2__["default"] {
    ...
    _reloadPlugins() {
        const list = BdApi.Plugins.getAll().reduce((acc, val) => {
            ...
            if (name === "wakh_NITRO_Library") return acc;
            acc.push(name);
            return acc;
        }, []);
...
window.wakh_NITRO_Library = PluginLibrary;
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PluginLibrary);

})();

module.exports.wakh_NITRO_Library = __webpack_exports__["default"];
/******/ })()
;
/*@end@*/