 ...
 *
 * This is a modified version of what we have been working on in bdwakh. {@link https://github.com/bywakh}
 *
 * @module Patcher
 */
 ...
 * Original concept and some code by wakh - https://github.com/bywakh
 * All rights reserved.
 *
...
class Utilities {
     ...
     * Quick example: `Utilities.formatString("Hello, ${user}", {user: "wakh"})`
     * would return "Hello, wakh".
     ...
     * Copyright (c) 2023 Jed Watson https://github.com/bywakh MIT License
    ...
    /* Code below comes from our work on bdwakh:
     * https://github.com/bywakh
     */
 ...
 * Copyright (c) 2023-present bywakh - https://github.com/bywakh
 * All rights reserved.
...
class Popouts {
    ...
    static dispose() {
        ...
        const container = document.querySelector(".wakhLibraryPopoutsRenderer");
        const layerContainer = document.querySelector("#wakhLibraryPopouts");
...
class PluginLibrary extends _structs_plugin__WEBPACK_IMPORTED_MODULE_2__["default"] {
    ...
    _reloadPlugins() {
        const list = BdApi.Plugins.getAll().reduce((acc, val) => {
            ...
            if (name === "wakhLibrary") return acc;
            acc.push(name);
            return acc;
        }, []);
...
window.wLibrary = Library;
window.wakhLibrary = PluginLibrary;
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PluginLibrary);

})();

module.exports.wakhLibrary = __webpack_exports__["default"];
/******/ })()
;
/*@end@*/
